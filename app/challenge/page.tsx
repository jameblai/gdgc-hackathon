...
const APPLICANTS: Applicant[] = [
  {
    ...
    status: "Claimed",
    canEdit: false,
    bio: "I am a Doctor with 2 years of residency",
    profileImage:
      "https://api.dicebear.com/9.x/notionists/svg?seed=franklin&backgroundColor=b6e3f4",
    proofImages: [
      "https://placehold.co/200x150/e0f2fe/0369a1?text=Proof+1",
      "https://placehold.co/200x150/dcfce7/15803d?text=Proof+2",
      "https://placehold.co/200x150/fef9c3/a16207?text=Proof+3",
    ],
  },
  {
    id: 2,
    ...
    status: "Flagged",
    canEdit: true,
    bio: "Registered nurse with 5 years ICU experience",
    profileImage:
      "https://api.dicebear.com/9.x/notionists/svg?seed=marcus&backgroundColor=ffd5dc",
    proofImages: [
      "https://placehold.co/200x150/ffe4e6/be123c?text=Proof+1",
      "https://placehold.co/200x150/fce7f3/9d174d?text=Proof+2",
      "https://placehold.co/200x150/f3e8ff/7e22ce?text=Proof+3",
    ],
  },
  {
    id: 3,
    ...
    status: "Claimed",
    canEdit: true,
    bio: "Pharmacist, 8 years in clinical practice",
    profileImage:
      "https://api.dicebear.com/9.x/notionists/svg?seed=serena&backgroundColor=c0aede",
    proofImages: [
      "https://placehold.co/200x150/e0e7ff/3730a3?text=Proof+1",
      "https://placehold.co/200x150/cffafe/0e7490?text=Proof+2",
      "https://placehold.co/200x150/d1fae5/065f46?text=Proof+3",
    ],
  },
  {
    id: 4,
    ...
    status: "Claimed",
    canEdit: true,
    bio: "Physiotherapist specialising in sports rehab",
    profileImage:
      "https://api.dicebear.com/9.x/notionists/svg?seed=priya&backgroundColor=d1d4f9",
    proofImages: [
      "https://placehold.co/200x150/fef3c7/92400e?text=Proof+1",
      "https://placehold.co/200x150/f0fdf4/14532d?text=Proof+2",
      "https://placehold.co/200x150/eff6ff/1e40af?text=Proof+3",
    ],
  },
];
