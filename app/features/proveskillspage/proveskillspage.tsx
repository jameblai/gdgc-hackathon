...
const SKILLS_DATA: Skill[] = [
  ...
  },
  {
    ...
    status: "flagged",
    question: "How does Ethernet work?",
  },
  {
    id: 3,
    title: "CSS Architecture",
    status: "unclaimed",
    question: "Explain the box model and stacking context.",
  },
  {
    id: 4,
    title: "TypeScript",
...
function btnStyle(
  ...
  return {
    background: bg,
    color,
    border: `1.5px solid ${borderColor === "transparent" ? bg : borderColor}`,
    borderRadius: 8,
    padding: "7px 16px",
    fontSize: 13,
    fontWeight: 600,
      ...
      <div style={{ display: "flex", gap: 8, marginTop: 4 }}>
        {skill.status === "claimed" ? (
          ...
          <button
            ...
            style={btnStyle("transparent", "#7C4DFF", "#7C4DFF")}
          >
            Edit
          </button>
        )}
    ...
    >
      <div
        style={{
          ...
          width: "90%",
          maxWidth: 480,
          boxShadow: "0 24px 48px rgba(124,77,255,0.15)",
          border: "1.5px solid #ede9fe",
        }}
      >
        <div
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ marginBottom: 36 }}>
            ...
            <p style={{ fontSize: 14, color: "#6b7280" }}>
              Claim your skills by answering questions to verify your knowledge.
            </p>
          </div>
          <div
          ...
          >
            {skills.map((skill) => (
              <SkillCard
                key={skill.id}
                skill={skill}
                onView={() => setModal(skill)}
                onEdit={() => setModal(skill)}
              />
            ))}
          </div>
